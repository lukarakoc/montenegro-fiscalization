...
/**
 * Utility class for validating XML documents against XSD schemas.
 * This class provides functionality to ensure that XML documents conform to
 * the specified XML Schema Definition (XSD).
 */
@UtilityClass
public class XSDValidator {
    /**
     * Validates an XML document against an XSD schema.
     * This method loads the XSD schema from the specified path and validates
     * the provided XML source against it.
     *
